 ...
 */
class IRCConnection extends \lang\Object implements Traceable {
  public
    $sock         = null,
    $cat          = null,
    $user         = null,
  ...
  static function __static() {
    \lang\XPClass::forName('peer.irc.IRCConstants');  // TODO: Use class constants
  }
  ...
  public function setNick($nick) {
    if (!$this->sock->isConnected()) {
      throw new \lang\IllegalStateException('Not connected');
    }
